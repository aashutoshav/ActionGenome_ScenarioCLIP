...
from dataloaders.glamm_dataset import GLaMMwDinoResp_Dataset, custom_collate_glammwDino
from dataloaders.MMT_dataset import MMTwDinoResp_Dataset, custom_collate_mmtwDino
from dataloaders.coco_dataset import COCOwDinoResp_Dataset, custom_collate_cocowDino
from dataloaders.vanilla_dataset import VanillawDinoResp_Dataset, custom_collate_cocowDino
...
class GroundedSam:
    ...
    def create_dataset(self, args):
        ...
        if "glamm" in args.root_dir.lower():
            image_dataset = GLaMMwDinoResp_Dataset(
            ...
            image_loader = DataLoader(
                ...
                shuffle=False,
                collate_fn=custom_collate_glammwDino,
            )
        elif "multi" in args.root_dir.lower():
            image_dataset = MMTwDinoResp_Dataset(
                root_dir=args.root_dir,
                start_chunk=args.start_chunk,
                end_chunk=args.end_chunk,
            ...
            image_loader = DataLoader(
                ...
                num_workers=args.max_workers,
                shuffle=False,
                collate_fn=custom_collate_mmtwDino,
            )

        elif "coco" in args.root_dir.lower():
            image_dataset = COCOwDinoResp_Dataset(
                root_dir=args.root_dir,
            ...
            image_loader = DataLoader(
                ...
                num_workers=args.max_workers,
                shuffle=False,
                collate_fn=custom_collate_cocowDino,
            )

        elif "vanilla" in args.root_dir.lower():
            image_dataset = VanillawDinoResp_Dataset(
                root_dir=args.root_dir,
                chunk_json_path=args.chunk_json_path,
                metadata_json_path=args.metadata_json_path,
                storage_dir=args.storage_dir,
...
def main():
    ...
    parser.add_argument(
        ...
        # default='/scratch/saali/Datasets/coco',
    ...
    parser.add_argument(
        ...
        default="/scratch/saali/Datasets/MMT_results",
        # default="./mmt_results",
    ...
    parser.add_argument(
        ...
        # default="../dataset/train_chunks.json"
    )
    parser.add_argument(
        "--metadata_json_path",
        type=str,
    ...
    parser.add_argument("--end_chunk", type=int, default=364, help="End chunk index")
